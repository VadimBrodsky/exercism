...
def is_criticality_balanced(
    ...
    if temperature >= 800:
        ...
        return False
    elif temperature * neutrons_emitted >= 500_000:
        return False
    else:
        return True
...
def fail_safe(
    ...
    temp_per_neurons = temperature * neutrons_produced_per_second
    threshold_percentage = temp_per_neurons / threshold * 100
    threshold_difference = abs((threshold - temp_per_neurons) / threshold * 100)

    if threshold_percentage < 90:
        return "LOW"
    elif 0 <= threshold_difference <= 10:
        return "NORMAL"
    else:
        return "DANGER"
